...
- You can [`annotate`](../../ref/models/querysets.html#django.db.models.query.QuerySet.annotate) and [aggregate](aggregation.html) using many built-in [database functions](../../ref/models/database-functions.html). Beyond those, you can create
...
can be iterated over like a normal [`QuerySet`](../../ref/models/querysets.html#django.db.models.query.QuerySet) to
...
[`db_table`](../../ref/models/options.html#django.db.models.Options.db_table) option, which also lets you manually set the
database table name.
...
(see [`defer()`](../../ref/models/querysets.html#django.db.models.query.QuerySet.defer)). This means that the
...
[`FieldDoesNotExist`](../../ref/exceptions.html#django.core.exceptions.FieldDoesNotExist) exception will be raised if
